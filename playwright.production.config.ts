...
export default defineConfig({
  ...
  webServer: { command: 'npm run start', url: `http://127.0.0.1:${port}/health`, timeout: 30_000, reuseExistingServer: false, env: { NODE_ENV: 'production', PORT: String(port), CLIENT_ORIGIN: '', ENABLE_TEST_API: 'true' } },
});
