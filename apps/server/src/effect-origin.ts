...
export function childOrigin(parent: EffectOriginMetadata, eventId: string, originType: EffectOriginType, source?: Pick<EffectOriginMetadata, 'sourceCharacterId' | 'sourceAbilityId'>): EffectOriginMetadata {
  ...
  return { ...parent, ...source, eventId, parentEventId: parent.eventId, originType, generationDepth, canBeCopied: originType === 'COPIED' ? false : parent.canBeCopied, canBeConverted: originType === 'CONVERTED' ? false : parent.canBeConverted };
}
